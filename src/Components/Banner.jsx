...
const Banner = () => {
    return (
        <div>
            <div
                className="min-h-screen flex items-center relative overflow-hidden px-8 md:px-24 w-[1700px]"
                style={{
            ...
            >
                ...
                <div className="z-10 text-left">
                    <div className='flex items-baseline gap-17'>
                        ...
                        <div className=" border border-black rounded-full  pt-23 pl-24 pr-20 -rotate-45 pb-32 ">
